                ...
                <div class="tile-body tile-footer">
                    ...
                    <form class="row" method="post" action="{{ route('employee-salary.update',$employeeSalaries->id) }}">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class=" form-control" name="OT_hour" placeholder="OT Hour" value="{{$employeeSalaries->OT_hour}}">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">OT Rate</label>
                            <input type="text"  class=" form-control" name="OT_rate" value="{{$employeeSalaries->OT_rate}}"   placeholder="OT Rate">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Total Over Time</label>
                            <input type="text"  class=" form-control" name="total_over_time" value="{{$employeeSalaries->total_over_time}}"  placeholder="Total Over Time">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Attendence Bonus</label>
                            <input type="text"  class=" form-control" name="attendance_bonus" value="{{$employeeSalaries->attendance_bonus}}" placeholder="Attendence Bonus">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Tips</label>
                            <input type="text" class="form-control" id="tips" name="tips" value="{{$employeeSalaries->tips}}" placeholder="Tips">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Total Salary</label>
                            <input type="text" class=" form-control" name="total_salary" value="{{$employeeSalaries->total_salary}}" placeholder="Total Salary">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Advance Salary</label>
                            <input type="text" class=" form-control" name="advance_salary" value="{{$employeeSalaries->advance_salary}}" placeholder="Advance Salary">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Uniform Value</label>
                            <input type="text"  class=" form-control" name="uniform_value" value="{{$employeeSalaries->uniform_value}}" placeholder="Uniform Value">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Uniform Advance</label>
                            <input type="text" class=" form-control" name="uniform_advance" value="{{$employeeSalaries->uniform_advance}}" placeholder="Uniform Advance">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Uniform Deduction</label>
                            <input type="text"  class=" form-control" name="uniform_deduction" value="{{$employeeSalaries->uniform_deduction}}" placeholder="Uniform Deduction">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Due Salary</label>
                            <input type="text" class="form-control" id="service_unit_id_1" value="{{$employeeSalaries->due_salary}}" name="due_salary" placeholder="Due Salary">
                        </div>
                        <div class="form-group col-md-3">
