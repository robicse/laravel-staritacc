...
{{--        <li><a class="app-menu__item {{Request ::is('home') ? ' active ' : ''}}" href="{!! URL::to('/home') !!}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>--}}
        ...
        <li class="treeview{{Request::is('customer*') ? ' is-expanded': ''}}" style="display:none;"><a class="app-menu__item" href="#" data-toggle="treeview">
        ...
        <li style="display:none;" class="treeview{{Request::is('services*')||Request::is('services*') ||Request::is('serviceCategory')||Request::is('serviceSubCategory*') || Request::is('serviceUnit') || Request::is('service') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-arrow-down"></i><span class="app-menu__label">Services </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
        ...
        <li style="display:none;" class="treeview{{Request::is('serviceSale*') ||Request::is('dueList*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview">
...
{{--                <li style="background-color: gray"><a class="app-menu__item" href="{{ route('serviceSaleDetails.create') }}"><i class="app-menu__icon fas fa-users"></i> <span class="app-menu__label">Service Sale Details Create</span></a></li>--}}
        ...
        <li style="display:none;" class="treeview{{Request::is('expenseCategory*') || Request::is('expenses*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-toggle-down"></i><span class="app-menu__label">Office Expenses </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
        ...
        <li class="treeview{{Request::is('account/coa_print*') || Request::is('account/coa_print*')|| Request::is('transaction*')|| Request::is('account/cashbook*')|| Request::is('account/trial-balance*')|| Request::is('account/credit-voucher*') || Request::is('account/debit-voucher*') || Request::is('account/generalledger*')  ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text-o"></i> <span class="app-menu__label">Accounts </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li  style="background-color: gray"><a class="app-menu__item" href="{!! URL::to('/account/bankbook/generalledger') !!}"><span class="app-menu__label">Bank Book</span></a></li>
