...
{{--        <li><a class="app-menu__item {{Request ::is('home') ? ' active ' : ''}}" href="{!! URL::to('/home') !!}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>--}}
        @php
            ...
            //if(Auth::User()->role=='1'){
        @endphp
        <li class="treeview{{Request::is('customer*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Customer</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li class="treeview{{Request::is('services*')||Request::is('services*') ||Request::is('serviceCategory')||Request::is('serviceSubCategory*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Services </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li  style="background-color: gray"><a class="app-menu__item" href="{{ route('serviceUnit.index') }}"><span class="app-menu__label">Service Unit</span></a></li>
                <li  style="background-color: gray"><a class="app-menu__item" href="{{ route('service.index') }}"><span class="app-menu__label">service</span></a></li>
            </ul>
        </li>
        ...
        <li class="treeview{{Request::is('serviceSale*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Service Sale </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
...
{{--                <li style="background-color: gray"><a class="app-menu__item" href="{{ route('serviceSaleDetails.create') }}"><i class="app-menu__icon fas fa-users"></i> <span class="app-menu__label">Service Sale Details Create</span></a></li>--}}
        ...
        <li class="treeview{{Request::is('employee*') || Request::is('employee-salary*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Employee </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
        ...
        <li class="treeview{{Request::is('employee-salary*') || Request::is('employee-salary*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Employee Salary </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
        ...
        <li class="treeview{{Request::is('expenseCategory*') || Request::is('expenses*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Office Expenses </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
        ...
        <li class="treeview{{Request::is('voucherType*') || Request::is('expenses*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Voucher Types</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
        ...
        <li class="treeview{{Request::is('account/coa_print*') || Request::is('account/coa_print*') ? ' is-expanded': ''}}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Accounts </span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
