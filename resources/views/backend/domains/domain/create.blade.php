...
@section('content')
    <main class="app-content">
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Add Domain</h3>
                <div class="tile-body tile-footer">
                    ...
                    <form method="post" action="{{ route('domain.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder=" Domain Name" name="domain_name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right"> Contact Info <span style="color: red">*</span></label>
                            <div class="col-md-8">
                                <input class="form-control" type="text" placeholder="Contact Info" name="contact_info">
                            </div>
                        </div>
{{--                        <div class="form-group row">--}}
{{--                            <label class="control-label col-md-3 text-right"> Code No <span style="color: red">*</span></label>--}}
{{--                            <div class="col-md-8">--}}
{{--                                <input class="form-control" type="text" placeholder="Code No" name="code_no">--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="datepicker form-control" type="text" value="{{date('Y-m-d')}}" name="expire_date">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Domain</button>
                            </div>
                        </div>
                    </form>
                </div>
