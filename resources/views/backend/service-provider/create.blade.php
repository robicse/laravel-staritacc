        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body tile-footer">
                    ...
                    @endif
                    <form method="post" action="{{ route('serviceProvider.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control{{ $errors->has('cost') ? ' is-invalid' : '' }}" type="text" placeholder="Cost" name="cost">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right"> Address <span style="color: red">*</span></label>
                            <div class="col-md-8">
                                <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" placeholder="Address" name="address">
